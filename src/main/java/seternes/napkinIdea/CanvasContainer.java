...
public class CanvasContainer extends Pane {
    ...
    public void init(Canvas c, ToolController tc) {
        this.canvas = c;
        this.tc = tc;
    ...
    public void returnCanvasToCenter() {
        this.offsetX = 0;
        this.offsetY = 0;
        this.canvas.setTranslateX(this.getWidth() / 2 + this.canvas.getWidth() / 2 - this.offsetX);
        this.canvas.setTranslateY(this.getHeight() / 2 + this.canvas.getHeight() / 2 - this.offsetY);
    }
